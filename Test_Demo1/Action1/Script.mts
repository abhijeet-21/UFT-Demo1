...
Browser("Advantage Shopping").Page("Advantage Shopping").Link("Link").Click @@ hightlight id_;_Browser("Advantage Shopping").Page("Advantage Shopping").Link("Link")_;_script infofile_;_ZIP::ssf6.xml_;_
...
Browser("Advantage Shopping").CloseAllTabs @@ hightlight id_;_197176_;_script infofile_;_ZIP::ssf8.xml_;_
