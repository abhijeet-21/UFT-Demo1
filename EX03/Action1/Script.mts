...
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("addcartNumber").Highlight
...
Browser("Advantage Shopping").CloseAllTabs @@ hightlight id_;_329338_;_script infofile_;_ZIP::ssf7.xml_;_
